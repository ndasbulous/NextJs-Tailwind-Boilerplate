...
export default function RootLayout({
  ...
  function displayStaticDesktopSidebar() {
  ...
  function displayMobileTopbar() {
    return <div className="sticky top-0 z-40 flex items-center gap-x-6 bg-gray-900 px-4 py-4 shadow-xs sm:px-6 lg:hidden">
  ...
  return (
    <html className="h-full bg-white" data-theme="dark">
      <head>
